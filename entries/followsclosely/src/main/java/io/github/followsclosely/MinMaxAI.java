...
public class MinMaxAI implements ArtificialIntelligence {
    ...
    public Coordinate yourTurn(Board b) {
        ...
        Coordinate center = new Coordinate(board.getWidth() / 2, board.getHeight() / 2);
    ...
    public int score(MutableBoard board, int depth) {
        return (TicTacToeUtils.getTurnDetails(board, board.getLastMove()).wonGame()) ? 10 - depth : 0;
    }
}